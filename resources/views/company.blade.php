          ...
          <div class="row">
            ...
            <div class="col-md-5">
              ...
              <div class="touch-slider" data-slider-navigation="true" data-slider-pagination="true">
                <div class="item"><img alt="" src="{{ asset('assets/images/about-01.jpg') }}"></div>
                <div class="item"><img alt="" src="{{ asset('assets/images/about-02.jpg') }}"></div>
                <div class="item"><img alt="" src="{{ asset('assets/images/about-03.jpg') }}"></div>
              </div>
              <!-- End Touch Slider -->
