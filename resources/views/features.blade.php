...
<!-- Start Page Banner -->
    <div class="page-banner" style="padding:40px 0; background: url({{ asset('assets/images/slide-02-bg.jpg') }}) center #f9f9f9;">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h2>Services</h2>
        ...
        <div class="page-content">
          ...
          <div class="row">
            ...
            <div class="col-md-4 image-service-box">
              <img class="img-thumbnail" src="{{ asset('assets/images/service-01.jpg') }}" alt="" />
            ...
            <div class="col-md-4 image-service-box">
              <img class="img-thumbnail" src="{{ asset('assets/images/service-02.jpg') }}" alt="" />
              <h4>Great Support</h4>
              <p>Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis quasi architect.</p>
            </div>
            ...
            <div class="col-md-4 image-service-box">
              <img class="img-thumbnail" src="{{ asset('assets/images/service-03.jpg') }}" alt="" />
            ...
            <div class="col-md-8">
              ...
              <div class="our-clients">
                ...
                <div class="clients-carousel custom-carousel touch-carousel" data-appeared-items="4">
                  ...
                  <!-- Client 6 -->
                  <div class="client-item item">
                    <a href="#"><img src="{{ asset('ass') }}ets/images/c6.png') }}" alt="" /></a>
                  </div>
